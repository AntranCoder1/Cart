        ...
        return (
            <main class="l-main">
                ...
                <section className="home" id="home">
                    <div className="home_container bd-container bd-grid">
                        <div className="home_data">
                            <h1 className="home_title">Tasty Food</h1>
                            <h2 className="home_subtitle">Try the best food of <br /> the week. </h2>
                            <Link to="/product" className="button">View Menu</Link>
                        </div>
                        <img src={Home} alt="" className="home_img" />
                    </div>
                </section>
                ...
                <section class="about section bd-container" id="about">
                    <div class="about_container bd-grid">
                        <div class="about_data">
                            ...
                            <h2 class="section-title about_initial">We cook the best <br /> tasty food </h2>
                            <p class="about_description">
                                We cook the best food in the entire city, with excellent customer service, the best meals and 
                                at the best price, visit us.
                            </p>
                            <Link to="#" class="button">Explore history</Link>
                        </div>

                        <img src={About} alt="" class="about_img" />
                    </div>
                </section>
                ...
                <section className="services section bd-container" id="services">
                    ...
                    <div className="services_container bd-container bd-grid">
                        <div className="services_content">
                            <svg className="services_img" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <h3 className="services_title">Excellent food</h3>
                        ...
                        <div className="services_content">
                            ...
                            <h3 className="services_title">Fast food</h3>
                            <p className="services_description">
                                We offer our clients excellent quality services for many years, with
                                the best and delicious food in the city.
                            </p>
                        ...
                        <div className="services_content">
                            ...
                            <h3 className="services_title">Delivery</h3>
                            <p className="services_description">
                                We offer our clients excellent quality services for many years, with
                                the best and delicious food in the city.
                            </p>
                ...
                <section className="app section bd-container">
                    <div className="app_container bd-grid">
                        <div className="app_data">
                            <span className="section-subtitle app_initial">App</span>
                            <h2 className="section-title app_initial">App is avilable</h2>
                            <p className="app_description">
                                Find our application and download it, you can make reservations, food orders, see
                                your deliveries on the way and much more.
                            </p>

                            <div className="app_stores">
                                <Link to="#">
                                    <img src={App1} alt="" className="app_store" />
                                </Link>

                                <Link to="#">
                                    <img src={App2} alt="" className="app_store" />
                                </Link>
                            </div>
                        </div>

                        <img src={Movil} alt="" className="contact" />
                    </div> 
                </section>
                ...
                <section className="contact section bd-container" id="contact">
                    <div className="contact_container bd-grid">
                        <div className="contact_data">
                            ...
                            <h2 className="section-title contact_initial">Contact us</h2>
                            <p className="contact_description">
                                If you want to reserve a table in our restaurant, contact us and we will attend you 
                                quickly, with our 24/7 chat services.
                            </p>
                        </div>
